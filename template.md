...
And, of course emoji! [:sparkles: :camel: :boom:](https://www.webfx.com/tools/emoji-cheat-sheet/)
...
| Ⅰ | Ⅱ | Ⅲ | Ⅳ | Ⅴ |
| :--------: | :---------: | :---------: | :---------: | :---------: |
| Solver[:hammer:](#hammer-Solver) | Visualization[:computer:](#computer-Visualization)|DataBase[:floppy_disk:](#floppy_disk-Database)| Programming[:speak_no_evil:](#speak_no_evil-Programming)| Memos[:memo:](#memo-Memos) |
...
<!-- [![](https://img.shields.io/badge/>-gitter-blue.svg)](https://gitter.im/CyC2018-Interview-Notebook/Lobby?utm_source=share-link&utm_medium=link&utm_campaign=share-link)-->

### :hammer: Solver 

- [非线性方程组](https://github.com/CyC2018/InnterviewNotes/blob/master/notes/Git.md)
